...
import { MUSIC_PLAY_LIST_ITEM_U2 } from '../../constants/api';
...
class MusicList extends Component {
	...
	_retrieveMoviesList(isRefreshed) {
		this.props.actions.retrieveMoviesList(this.props.type, this.state.currentPage,MUSIC_PLAY_LIST_ITEM_U2)
			.then(() => {
