...
import { POPULAR_PLAY_LIST_ITEM_U2 } from '../../constants/api';
...
class PopularList extends Component {
	...
	_retrieveMoviesList(isRefreshed) {
		this.props.actions.retrieveMoviesList(this.props.type, this.state.currentPage,POPULAR_PLAY_LIST_ITEM_U2)
			.then(() => {
	...
	_retrieveNextPage(type) {
		...
		if (totalItem < this.state.totalResults) {
			...
			this.props.actions.retrieveMoviesList(this.props.type, 1,POPULAR_PLAY_LIST_ITEM_U2,nextPage)
				.then(() => {
